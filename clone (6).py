...
from config import APP_ID, API_HASH, ADMINS, CUSTOM_CAPTION
from config import DB_URI as MONGO_URL
from clone_config import cloneconfig
CLONE_FILE_CHANNEL = "-1002136916210"
...
@Client.on_message(filters.command("DB_URI") & filters.private)
async def set_database_uri(client, message):
    try:
        ...
        DB_URI = database_uri  # Use Config.DATABASE_URI to set the attribute directly
