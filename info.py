...
BOT_TOKEN = environ.get('BOT_TOKEN', "6832943472:AAHymLsqTu42nNRCAePWTKLh0oMBeAX_OnE")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/387d2fbef1e9be2d78d30.jpg https://graph.org/file/9a5e509805fe2b5707e19.jpg https://graph.org/file/51586ac3affdacce111aa.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1976189133').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sumitnadiyaias:Sumit9737@cl.pafjwdk.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Ghostbaja')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001851831036'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Ghostbaja')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001851831036')).split()]
...
QUALITY= ["PreDvd", "S print", "HDTC", "HDTS", "HDcam", "480p", "720p", "1080p", "1440p", "2160p"]
